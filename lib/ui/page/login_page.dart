    ...
    return Scaffold(
      body: Column(children: [
        Container(
          ...
          child: Icon(Icons.check, color: Colors.redAccent, size: 128,),
        ),
        Text("Welcome to Demi", textScaleFactor: 2, style: TextStyle(fontWeight: FontWeight.bold),),
        Container(
        ...
        Column(children: [
            Padding(
              ...
              child: Text("Copyright (c) Shockbytes Studio 2019"),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
